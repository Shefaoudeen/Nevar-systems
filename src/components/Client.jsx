...
const Client = () => {
  ...
  return (
    <div className="w-full select-none flex h-screen bg-gradient-to-tr from-gray-700 via-gray-900  to-gray-700">
      {/* our clients */}
      ...
      <div className="flex h-full flex-col pr-6">
        ...
        <div className="flex flex-col mt-24 items-center justify-center">
          <h1
            id="partners-title"
            className="text-5xl font-sans text-white font-semibold"
          >
            OUR PARTNERS
          </h1>
